...
1. Tecnologias Utilizadas	2
2. Estrutura do Projeto	3
3. Instalação e Configuração do Ambiente	4
4. Configuração do Dataset	5
5. Como Executar	6
6. Resultados Obtidos	7
7. Resultados Gráficos	8
7. Nota sobre o Uso de IA Generativa	10
...
Tela Inicial ao rodar o python main.py (É possível ver os ciclos das épocas de 1 até 10)
...
Curva ROC Análise: A AUC de 1.00 demonstra um classificador ideal.
 
7. Nota sobre o Uso de IA Generativa
Conforme exigido pelo escopo do trabalho, este projeto foi desenvolvido com o auxílio de assistentes de IA generativa (Google Gemini e Claude).
•	As IAs foram "treinadas" com os documentos da disciplina (incluindo o .docx do trabalho, questionários e materiais de referência) para atuar como um "Professor Assistente".
•	Elas geraram o código-base do main.py, propuseram a estrutura do projeto e auxiliaram na depuração de ambiente e na análise dos resultados.
•	Limitação Crítica Identificada: O código gerado para carregar dados (ImageDataGenerator), embora funcional, é uma prática legada do TensorFlow. A abordagem moderna (tf.data.Dataset) é mais eficiente. Isso destaca a necessidade de sempre validar e contrastar o código da IA com a documentação oficial, tratando a IA como uma ferramenta de auxílio, e não como uma fonte de verdade absoluta.
